...
[run_experiment2.py](https://github.com/Slava2201/ACT-Theory/blob/main/run_experiment2.py)

# Run full simulation (L=16, requires more memory)
[scan_phase_hardcore.py](https://github.com/Slava2201/ACT-Theory/blob/main/scan_phase_hardcore.py)
